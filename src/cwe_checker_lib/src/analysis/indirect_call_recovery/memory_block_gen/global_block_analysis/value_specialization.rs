// This is effectifly a clone of value_specialization in pointer interference.
...
use crate::{
    abstract_domain::{RegisterDomain, SpecializeByConditional, TryToBitvec, TryToInterval},
    intermediate_representation::{BinOpType, CastOpType, Expression, UnOpType},
